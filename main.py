...
---------------------------------------------------------""")
    ...
    incoming_post = "OpenAI just released a new model that might replace junior developers."
    print(f"Incoming Post:\n\"{incoming_post}\"\n")
    
    # We route the post and find relevant bots
    ...
    # Take the top matched bot to proceed to Phase 2
